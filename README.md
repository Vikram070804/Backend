This is the backend service for the Zomato Clone application. It provides APIs for user authentication, restaurant management, food ordering, payment integration, and more.
